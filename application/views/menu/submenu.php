...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <?php endif; ?>
            <!-- form error hanya untuk 1 field <?= form_error('menu', '<div class="alert alert-danger" role="alert">', '
           </div>'); ?> -->
            <?= $this->session->flashdata('message'); ?>
            <a class="btn btn-primary mb-3" href="" data-toggle="modal" data-target="#newSubMenuModal">Add New Sub Menu</a>
